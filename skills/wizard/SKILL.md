---
name: wizard
description: Generate an interactive bash wizard for a manual setup, migration, or state transition that opens URLs, captures values, and persists them.
...
- Run `bash -n <script>` with `bash`; run `shellcheck` if available.
