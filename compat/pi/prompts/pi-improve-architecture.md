---
description: Apply improve-codebase-architecture to the supplied arguments.
---
...
Read `compat/pi/skills/improve-codebase-architecture/SKILL.md` inside that root and follow it.
